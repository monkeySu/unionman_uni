...
(function() {
  ...
  (LuShu.prototype.start = function() {
    ...
    if (me.i && me.i < len - 2) {
      ...
      if (!me._fromPause) {
        ...
        if(me._isPause) {
          // 如果是暂停再播放，直接从当前位置开始
          me._pauseNum++;
          me._path.splice(me.i + 1, 0, me._pausePos);
        } 
        me._moveNext(++me.i);
      }
    } else {
    ...
    (LuShu.prototype.stop = function() {
      ...
      if (!this._opts.landmarkPois || this._opts.landmarkPois.length < 1) return;
  ...
  LuShu.prototype.on = function(eventName, callback) {
    this.event[eventName] = this.event[eventName] || [];
    this.event[eventName].push(callback);
  };
  LuShu.prototype.emit = function(eventName) {
    var args = Array.prototype.slice.call(arguments, 1);
    for (let i = 0; i < this.event[eventName].length; i++) {
      this.event[eventName][i].apply(this, args);
    }
  };
   ...
   * @return 播放速度,米/秒.
   */
  LuShu.prototype.getSpeed = function() {
  ...
  baidu.object.extend(LuShu.prototype, {
    ...
    _removeMarker: function() {
      ...
      if (me._marker) {
        if (me._fromStop || (me.i >= me._path.length - 2)) {
          // 给 1s 缓冲时间
          setTimeout(function() {
      ...
      me._intervalFlag = setInterval(function() {
        ...
        if (currentCount >= count) {
          if (me._isPause) {
            // 暂停时添加的点，在走完这段后删掉
            me._isPause = false;
            me._path.splice(me.i - me._pauseNum + 1, me._pauseNum);
            me.i = me.i - me._pauseNum;
            me._pauseNum = 0;
          }
    ...
    _moveNext: function(index) {
      ...
      if (me._isPause) {
        ...
        me.emit('arriveToMarker', index, next.bind(this));
      }
