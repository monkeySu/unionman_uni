...
const INFOBOX_AT_TOP = 1; const INFOBOX_AT_RIGHT = 2; const INFOBOX_AT_BOTTOM = 3; const INFOBOX_AT_LEFT = 4;
(function() {
  // 声明baidu包
  let T; var baidu = T = baidu || { version: '1.5.0' };
  baidu.guid = '$BAIDU$';
  ...
  /**
     ...
     */
        = BMapLib.InfoBox = function(map, content, opts) {
          ...
          this._opts.closeIconUrl = opts.closeIconUrl || '/libs/offlinemap_v30/images/panorama/close.png';
  ...
  InfoBox.prototype.initialize = function(map) {
    ...
    const floatPane = map.getPanes().floatPane;
  ...
  baidu.object.extend(InfoBox.prototype, {
    /**
         ...
         */
    _getCloseIcon() {
      const img = `<img src='${this._opts.closeIconUrl}' align='right' style='width:16px;height:16px;position:absolute;right:0px;cursor:pointer;margin:${this._opts.closeIconMargin}'/>`;
      return img;
    },
    /**
	     * 设置infoBox的内容
    ...
    _panBox() {
      ...
      let panTop; let panBottom; let panY;
      // 左侧超出
